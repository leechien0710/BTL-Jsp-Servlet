...
<link rel="stylesheet" href="pageadmin/css/morris.css" type="text/css"/>
<!-- calendar -->
<link rel="stylesheet" href="pageadmin/css/monthly.css">
<!-- //calendar -->
<!-- //font-awesome icons -->
<script src="pageadmin/js/jquery2.0.3.min.js"></script>
<script src="pageadmin/js/raphael-min.js"></script>
<script src="pageadmin/js/morris.js"></script>
</head>
<body>
    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                <img alt="" src="pageadmin/images/2.png">
                <span class="username">Nhom 6</span>
                <b class="caret"></b>
            </a>
            <ul class="dropdown-menu extended logout">
<!--                <li><a href="#"><i class=" fa fa-suitcase"></i>Hồ sơ</a></li>
                <li><a href="#"><i class="fa fa-cog"></i>Cài dặt</a></li>-->
                <li><a href="home"><i class="fa fa-key"></i>Logout</a></li>
            </ul>
        </li>
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						...
						<li><a href="editproduct.jsp">Edit Product</a></li>
                                                <li><a href="shippinginfor.jsp">Shipping Information</a></li>        
                    </ul>
                </li>
...
<!--				<li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="typography.html">Thêm thương hiệu</a></li>
						<li><a href="glyphicon.html">Sửa thông tin thương hiệu</a></li>
                        <li><a href="grids.html">Thống kê thương hiệu</a></li>
                    </ul>
                </li>-->
            </ul>            
		</div>
...
<!-- calendar -->
	<script type="text/javascript" src="pageadmin/js/monthly.js"></script>
