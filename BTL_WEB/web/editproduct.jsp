  ...
  <div class="panel panel-default">
    ...
    <div class="table-responsive">
      <table class="table table-striped b-t b-light">
        ...
        <c:forEach items = "${sessionScope.lap}" var ="x">
          <tr>
              <td>${x.name} </td>
            <td><span class="text-ellipsis">${x.price} </span></td>
            ...
            <td>
                <a href="edit?p=${x.name}" class="active" ui-toggle-class="">
                  <i class="fa fa-check text-success text-active"></i>
              </a>
              <a href="delete?c=${x.id}" class="active" ui-toggle-class="">
