                        ...
                        <div class="panel-body">
                            ...
                            <form role="form" action="update" method="post" >
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="product_name" class="form-control" id="exampleInputEmail1" value="${p.name}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Product Price</label>
                                    <input type="text" name="product_price" class="form-control" id="exampleInputEmail1" value="${p.price}">
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Product Image</label>
                                    <input type="file" name="product_image" class="form-control" id="exampleInputEmail1" value="">
                                    <input type="hidden" name="image" value="${p.image}">
                                    <img src="images/home/${p.image}" with="100" height="100" />
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Product Description</label>
                                    <textarea style="resize: none;" rows="8" class="form-control" name="product_desc" id="exampleInputPassword1">${p.des}</textarea> 
                                </div>
                                ...
                                <button type="submit" name="add_category_product" class="btn btn-info">Update Product</button>
                            </form>
                            </div>
